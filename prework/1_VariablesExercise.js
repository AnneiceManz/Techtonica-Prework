...
// num2 but not num1?
    ...
    // Answer: The rule for num1 excludes numbers 1 and 10, but num2 is inclusive of 1 and 10.
    // Numbers 1 and 10 follow the rule for num2 but not num1.
...
const myAnswerForExercise12 = "boolean";
